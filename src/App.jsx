...
const TOC = {
  python: [
    "파이썬 환경 설정", "변수와 자료형", "연산자와 입출력", "조건문 if/elif/else", "반복문 for/while",
    "리스트와 튜플", "딕셔너리와 집합", "함수 def", "람다·map·filter", "클로저와 데코레이터",
    "이터레이터와 제너레이터", "예외 처리", "파일 입출력", "모듈과 패키지", "클래스와 객체",
    "상속·캡슐화·다형성", "정규표현식 re", "표준 라이브러리", "가상환경과 패키지 관리", "미니 프로젝트",
  ],
  math_elementary: [
    "자연수와 덧셈·뺄셈", "곱셈과 나눗셈", "분수 기초", "소수 기초", "도형 기초",
    "넓이와 둘레", "분수의 사칙연산", "비와 비율", "평균과 가능성", "측정 단위 변환",
  ],
  math_middle: [
    "정수와 유리수", "문자와 식", "일차방정식", "일차함수", "연립방정식", "부등식",
    "이차방정식", "도형의 성질", "피타고라스 정리", "확률과 통계 기초", "다항식 연산", "이차함수",
  ],
  math_high: [
    "집합과 명제", "함수의 개념", "지수와 로그", "삼각함수", "수열", "경우의 수·순열·조합",
    "확률", "통계", "미분 기초", "미분 응용", "적분", "벡터와 공간도형",
  ],
  english_elementary: [
    "알파벳과 파닉스", "기초 단어와 인사말", "기초 문장 만들기", "현재시제 기초",
    "be동사", "일상 표현과 회화", "과거시제 기초", "기초 의문사",
  ],
  english_middle: [
    "품사와 문장 5형식", "시제 (현재·과거·미래)", "현재완료", "조동사", "수동태",
    "to부정사와 동명사", "관계대명사 기초", "전치사", "비교 구문", "접속사",
  ],
  english_high: [
    "시제 완전 정복", "조동사 심화", "분사와 분사구문", "관계사 완전 정복", "가정법",
    "특수구문 강조·도치", "어휘 확장 전략", "독해 전략", "수능 문법 포인트", "에세이·서술형 작문",
  ],
  algorithm: [
    "시간·공간 복잡도 Big-O", "배열과 문자열", "투 포인터·슬라이딩 윈도우", "스택", "큐와 덱",
    "정렬 알고리즘", "이진 탐색", "해시 테이블", "트리 기초", "힙 Heap", "그래프 표현",
    "DFS", "BFS", "최단 경로 다익스트라", "DP 기초", "DP 심화", "그리디 알고리즘", "유니온 파인드·위상 정렬",
  ],
  science_elementary: [
    "동물의 세계", "식물의 세계", "물질의 상태 변화", "빛과 그림자", "소리와 진동",
    "자석과 전기", "날씨와 물의 순환", "지구와 달", "혼합물 분리", "우리 몸의 구조",
  ],
  science_middle: [
    "물질의 구성", "힘과 운동", "열과 에너지", "전기와 자기", "파동과 빛", "화학 반응",
    "산·염기와 중화", "세포와 생명활동", "유전과 진화", "지구와 지각 변동", "태양계와 우주", "생태계와 환경",
  ],
  science_physics: [
    "[물리Ⅰ] 힘과 운동", "[물리Ⅰ] 에너지", "[물리Ⅰ] 전기와 자기", "[물리Ⅰ] 파동", "[물리Ⅰ] 열역학",
    "[물리Ⅱ] 역학 심화", "[물리Ⅱ] 전자기학 심화", "[물리Ⅱ] 빛과 물질의 이중성", "[물리Ⅱ] 원자와 핵", "[물리Ⅱ] 상대성 이론",
  ],
  science_chemistry: [
    "[화학Ⅰ] 원자 구조", "[화학Ⅰ] 주기율표", "[화학Ⅰ] 화학 결합", "[화학Ⅰ] 분자 구조", "[화학Ⅰ] 화학 반응",
    "[화학Ⅰ] 산·염기·중화", "[화학Ⅱ] 화학 평형", "[화학Ⅱ] 산화·환원", "[화학Ⅱ] 반응 속도", "[화학Ⅱ] 유기 화합물",
  ],
  science_biology: [
    "[생Ⅰ] 세포 구조", "[생Ⅰ] 물질대사", "[생Ⅰ] 광합성과 호흡", "[생Ⅰ] 유전 정보", "[생Ⅰ] 세포 분열",
    "[생Ⅰ] 유전의 법칙", "[생Ⅱ] 생명의 기원", "[생Ⅱ] 유전자 발현 조절", "[생Ⅱ] 생물 진화", "[생Ⅱ] 생태계와 생물 다양성",
  ],
  science_earth: [
    "[지Ⅰ] 지구의 구조", "[지Ⅰ] 판 구조론", "[지Ⅰ] 대기와 해양", "[지Ⅰ] 날씨와 기후", "[지Ⅰ] 태양계",
    "[지Ⅰ] 별과 은하", "[지Ⅱ] 지질 시대", "[지Ⅱ] 해양 심층 순환", "[지Ⅱ] 대기 대순환", "[지Ⅱ] 우주론",
  ],
  data: [
    "환경 설정", "NumPy 기초", "NumPy 심화", "Pandas 기초", "데이터 불러오기·저장", "EDA 기초",
    "결측치·이상치 처리", "데이터 필터링·정렬", "groupby 집계", "피벗·merge·concat", "문자열·날짜 처리",
    "matplotlib 시각화", "seaborn 시각화", "스케일링·인코딩", "상관관계·통계 분석", "scikit-learn 입문",
    "모델 평가·검증", "데이터 분석 프로젝트",
  ],
  deeplearning: [
    "딥러닝 개요", "퍼셉트론과 신경망", "활성화 함수", "손실 함수와 옵티마이저", "역전파", "PyTorch 기초",
    "PyTorch 학습 루프", "오버피팅 방지", "배치 정규화", "CNN 기초", "CNN 심화 ResNet·VGG", "RNN·LSTM·GRU",
    "Attention 메커니즘", "Transformer", "전이 학습", "GAN 기초", "모델 평가 지표", "딥러닝 프로젝트",
  ],
  cv: [
    "이미지 데이터 기초", "OpenCV 기초·전처리", "에지 검출과 윤곽선", "Dataset과 DataLoader", "데이터 증강",
    "이미지 분류 모델 학습", "전이 학습 ResNet·EfficientNet", "객체 탐지 개념", "YOLO 실습", "Semantic Segmentation",
    "포즈 추정·얼굴 인식", "OCR", "비디오 처리", "CV 프로젝트",
  ],
  dlthon: [
    "Kaggle 환경 세팅", "대회 구조와 평가 지표", "EDA 실전", "베이스라인 모델", "Feature Engineering",
    "Cross Validation", "XGBoost·LightGBM", "Optuna 튜닝", "PyTorch Lightning", "앙상블 전략", "데이터 불균형 처리",
    "GPU 최적화", "리더보드 전략", "DLthon 프로젝트",
  ],
  nlp: [
    "NLP 개요·환경 설정", "텍스트 전처리", "토크나이징", "한국어 NLP KoNLPy", "BoW·TF-IDF", "Word2Vec",
    "텍스트 분류 ML", "LSTM 감성 분석", "Attention 메커니즘", "Transformer", "BERT 이해", "BERT 파인튜닝",
    "한국어 BERT", "NER", "텍스트 요약", "QA 시스템", "NLP 프로젝트",
  ],
  llm: [
    "LLM 개요", "Transformer 심화", "토크나이저 BPE·WordPiece", "프롬프트 엔지니어링 기초", "프롬프트 엔지니어링 심화",
    "OpenAI API", "Hugging Face 활용", "LangChain 기초", "LangChain Agent", "벡터 DB", "RAG",
    "Fine-tuning·LoRA·QLoRA", "로컬 LLM Ollama", "LLM 평가·할루시네이션", "멀티모달 LLM", "LLM 배포",
  ],
  mlops: [
    "MLOps 개요", "Git & GitHub", "MLflow 실험 추적", "DVC 데이터 버전 관리", "FastAPI 모델 서빙",
    "Docker 컨테이너화", "CI/CD GitHub Actions", "Airflow 파이프라인", "모델 드리프트 감지", "모델 모니터링",
    "Kubernetes 배포", "클라우드 ML 플랫폼", "A/B 테스트·Canary 배포", "MLOps 프로젝트",
  ],
};
...
const MATH_S = [
  { k: "elementary", l: "초등", c: "#34d399" },
  { k: "middle", l: "중등", c: "#f59e0b" },
  { k: "high", l: "고등", c: "#f472b6" },
];
...
const SCI_S = [
  { k: "elementary", l: "초등", c: "#34d399" },
  { k: "middle", l: "중등", c: "#f59e0b" },
  { k: "physics", l: "물리", c: "#38bdf8" },
  { k: "chemistry", l: "화학", c: "#a78bfa" },
  { k: "biology", l: "생명과학", c: "#fb923c" },
...
function fmt(text) {
  ...
  while ((match = re.exec(text)) !== null) {
    ...
    if (token.startsWith("`")) {
      ...
      parts.push(
        <strong key={match.index} style={{ color: "#e2e8f0", fontWeight: 700 }}>
          {token.slice(2, -2)}
        </strong>
      );
    } else {
      parts.push(
        <em key={match.index} style={{ color: "#a5b4fc" }}>
          {token.slice(1, -1)}
        </em>
      );
    }
...
function DetailsBlock({ lines }) {
  ...
  const summary =
    lines.find((line) => line.startsWith("<summary>"))?.replace(/<\/?summary>/g, "") || "정답 보기";
  const content = lines.filter(
    (line) => !line.startsWith("<summary>") && !line.startsWith("</summary>")
  );
  ...
  return (
    <div style={{ border: "1px solid #30363d", borderRadius: 8, margin: "8px 0", overflow: "hidden" }}>
      ...
      {open && (
        <div style={{ padding: "10px 14px", background: "#0d1117", borderTop: "1px solid #21262d" }}>
          {renderMd(content.join("\n"))}
        </div>
      )}
    </div>
  );
...
function renderMd(text) {
  ...
  for (let i = 0; i < lines.length; i += 1) {
    ...
    if (line.startsWith("```")) {
      if (!inCode) {
        ...
        result.push(
          ...
          >
            {codeLang && <div style={{ fontSize: 10, color: "#484f58", marginBottom: 6 }}>{codeLang}</div>}
            <code>{codeLines.join("\n")}</code>
          </pre>
        );
      }
    ...
    if (line.startsWith("</details>")) {
      inDetails = false;
      result.push(<DetailsBlock key={i} lines={detailsLines} />);
      continue;
    }
    ...
    if (line.startsWith("# ")) {
      result.push(
        <h2
          key={i}
          style={{ fontSize: 17, fontWeight: 700, color: "#58a6ff", margin: "16px 0 8px", borderBottom: "1px solid #21262d", paddingBottom: 6 }}
        >
          {line.slice(2)}
        </h2>
      );
    ...
    if (line.startsWith("## ")) {
      result.push(
        <h3 key={i} style={{ fontSize: 14, fontWeight: 700, color: "#e2e8f0", margin: "14px 0 6px" }}>
          {line.slice(3)}
        </h3>
      );
      continue;
    ...
    if (line.startsWith("### ")) {
      result.push(
        <h4 key={i} style={{ fontSize: 13, fontWeight: 700, color: "#c9d1d9", margin: "10px 0 4px" }}>
          {line.slice(4)}
        </h4>
      );
      continue;
    ...
    if (line.startsWith("> ")) {
      result.push(
        <blockquote key={i} style={{ borderLeft: "3px solid #58a6ff", paddingLeft: 10, margin: "6px 0", color: "#8b949e", fontSize: 12 }}>
          {fmt(line.slice(2))}
        </blockquote>
      );
      continue;
    ...
    if (line.startsWith("- ") || line.startsWith("* ")) {
      result.push(
        <li key={i} style={{ fontSize: 13, lineHeight: 1.7, color: "#c9d1d9", marginLeft: 16, marginBottom: 2 }}>
          {fmt(line.slice(2))}
        </li>
      );
      continue;
    ...
    if (/^\d+\. /.test(line)) {
      result.push(
        <li
          key={i}
          style={{ fontSize: 13, lineHeight: 1.7, color: "#c9d1d9", marginLeft: 16, marginBottom: 2, listStyleType: "decimal" }}
        >
          {fmt(line.replace(/^\d+\. /, ""))}
        </li>
      );
    ...
    if (line === "---") {
      result.push(<hr key={i} style={{ border: "none", borderTop: "1px solid #21262d", margin: "12px 0" }} />);
      continue;
    }
    ...
    result.push(
      <p key={i} style={{ fontSize: 13, lineHeight: 1.75, color: "#c9d1d9", margin: "3px 0" }}>
        {fmt(line)}
      </p>
    );
  }
...
export default function App() {
  ...
  const tocKey =
    subj === "math"
      ? `math_${sub.math}`
      : subj === "english"
      ? `english_${sub.english}`
      : subj === "science"
      ? `science_${sub.science}`
      : subj;
  ...
  async function handleClick(index, title) {
    ...
    const subText =
      subj === "math"
        ? `수학 ${{ elementary: "초등", middle: "중등", high: "고등" }[sub.math]} `
        : subj === "english"
        ? `영어 ${{ elementary: "초등", middle: "중등", high: "고등" }[sub.english]} `
        : subj === "science"
        ? `과학 ${
            {
              elementary: "초등",
      ...
      <div style={{ minHeight: "100vh", background: "#0d1117", color: "#e2e8f0", fontFamily: "'Noto Sans KR', system-ui, sans-serif", overflowY: "auto" }}>
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            ...
            <span style={{ fontSize: 11, background: "#1a2e1a", color: "#22c55e", padding: "2px 8px", borderRadius: 99, border: "1px solid #22c55e44", marginLeft: 4 }}>
              Gemini AI
            </span>
          </div>
        ...
        <div style={{ textAlign: "center", padding: "80px 24px 60px" }}>
          <h1 style={{ fontSize: "clamp(28px,5vw,52px)", fontWeight: 900, margin: "0 0 16px", lineHeight: 1.15, letterSpacing: "-0.03em" }}>
            공부가 막힐 때
            <br />
            <span style={{ background: "linear-gradient(90deg,#58a6ff,#7c5cfc)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
              StudyBot
            </span>
            에게 물어봐
          </h1>
          <p style={{ fontSize: 15, color: "#8b949e", maxWidth: 480, margin: "0 auto 36px", lineHeight: 1.7 }}>
            12개 과목 · 200개 이상의 학습 주제
            <br />
            클릭 한 번으로 Gemini AI가 바로 설명해드려요
          </p>
          <button
            onClick={() => setPage("app")}
            style={{ padding: "12px 32px", borderRadius: 10, border: "none", background: "#58a6ff", color: "#000", fontSize: 15, fontWeight: 700, cursor: "pointer" }}
          >
            📚 지금 바로 시작하기
          </button>
        </div>
  ...
  return (
    <div style={{ height: "100vh", display: "flex", flexDirection: "column", background: "#0d1117", color: "#e2e8f0", fontFamily: "'Noto Sans KR', system-ui, sans-serif", overflow: "hidden", fontSize: 13 }}>
      <div style={{ background: "#161b22", borderBottom: "1px solid #21262d", padding: "7px 12px", display: "flex", alignItems: "center", gap: 5, overflowX: "auto", flexShrink: 0, scrollbarWidth: "none" }}>
        ...
        <span style={{ fontSize: 10, background: "#1a2e1a", color: "#22c55e", padding: "1px 7px", borderRadius: 99, border: "1px solid #22c55e44", marginRight: 4, flexShrink: 0 }}>
          Gemini
        </span>

        {GROUPS.map((group) => (
          <span key={group.label} style={{ display: "flex", alignItems: "center", gap: 4 }}>
            <span style={{ fontSize: 10, color: "#484f58", borderLeft: "1px solid #21262d", paddingLeft: 8, marginLeft: 2, whiteSpace: "nowrap" }}>{group.label}</span>
            {group.keys.map((key) => (
              <button
                key={key}
                onClick={() => {
                ...
                style={{
                  ...
                  borderRadius: 16,
                  border: "1px solid",
                  borderColor: key === subj ? "#58a6ff" : "#21262d",
                  background: key === subj ? "#58a6ff" : "transparent",
                  color: key === subj ? "#000" : "#8b949e",
                  fontSize: 11,
                  cursor: "pointer",
                  whiteSpace: "nowrap",
                  fontWeight: key === subj ? 700 : 400,
                }}
              >
      ...
      <div style={{ background: "#161b22", borderBottom: "1px solid #21262d", padding: "6px 12px", display: "flex", alignItems: "center", gap: 6, flexShrink: 0 }}>
        ...
        {Object.entries(LVL).map(([key, value]) => pill(value.label, level === key, value.color, () => setLevel(key)))}
      </div>
      ...
      {subj === "math" && (
        <div style={{ background: "#161b22", borderBottom: "1px solid #21262d", padding: "6px 12px", display: "flex", gap: 6, flexShrink: 0 }}>
          {MATH_S.map(({ k, l, c }) => (
            <button
              key={k}
              onClick={() => setSub((prev) => ({ ...prev, math: k }))}
              style={{
                flex: 1,
                padding: "4px",
                borderRadius: 8,
                border: "1px solid",
                borderColor: sub.math === k ? c : "#21262d",
                background: sub.math === k ? `${c}33` : "transparent",
                color: sub.math === k ? c : "#484f58",
                fontSize: 12,
                fontWeight: sub.math === k ? 700 : 400,
                cursor: "pointer",
              }}
            >
              {l}
      ...
      {subj === "english" && (
        <div style={{ background: "#161b22", borderBottom: "1px solid #21262d", padding: "6px 12px", display: "flex", gap: 6, flexShrink: 0 }}>
          {ENG_S.map(({ k, l, c }) => (
            <button
              key={k}
              onClick={() => setSub((prev) => ({ ...prev, english: k }))}
              style={{
                flex: 1,
                padding: "4px",
                borderRadius: 8,
                border: "1px solid",
                borderColor: sub.english === k ? c : "#21262d",
                background: sub.english === k ? `${c}33` : "transparent",
                color: sub.english === k ? c : "#484f58",
                fontSize: 12,
                fontWeight: sub.english === k ? 700 : 400,
                cursor: "pointer",
              }}
            >
              {l}
      ...
      {subj === "science" && (
        <div style={{ background: "#161b22", borderBottom: "1px solid #21262d", padding: "6px 12px", display: "flex", flexWrap: "wrap", gap: 5, flexShrink: 0 }}>
          {SCI_S.map(({ k, l, c }) => (
            <button
              key={k}
              onClick={() => setSub((prev) => ({ ...prev, science: k }))}
              style={{
                flex: "1 1 calc(33% - 5px)",
                padding: "4px",
                borderRadius: 8,
                border: "1px solid",
                borderColor: sub.science === k ? c : "#21262d",
                background: sub.science === k ? `${c}33` : "transparent",
                color: sub.science === k ? c : "#484f58",
                fontSize: 11.5,
                fontWeight: sub.science === k ? 700 : 400,
                cursor: "pointer",
                textAlign: "center",
              }}
            >
      ...
      <div style={{ flex: 1, display: "flex", overflow: "hidden" }}>
        <div style={{ width: 220, flexShrink: 0, overflowY: "auto", borderRight: "1px solid #21262d", padding: "8px" }}>
          <div style={{ fontSize: 10, color: "#484f58", padding: "2px 8px 8px", letterSpacing: "0.08em", textTransform: "uppercase" }}>
            {subjectInfo.emoji} {subjectInfo.name} · {LVL[level].label}
          </div>
          ...
          {items.map((title, index) => (
            <div
              ...
              style={{
                ...
                cursor: "pointer",
                border: "1px solid",
                borderColor: activeIdx === index ? "#58a6ff" : "#21262d",
                background: activeIdx === index ? "#1f3354" : "#161b22",
                display: "flex",
                gap: 8,
            ...
            >
              <span style={{ color: "#484f58", fontSize: 10, fontFamily: "monospace", minWidth: 18, flexShrink: 0, marginTop: 2 }}>
                {index + 1}.
              </span>
              <span style={{ color: activeIdx === index ? "#58a6ff" : "#c9d1d9", fontSize: 12, lineHeight: 1.45 }}>{title}</span>
            </div>
          ))}
        </div>
        ...
        <div ref={answerRef} style={{ flex: 1, overflowY: "auto", padding: "16px 20px" }}>
          ...
          {error && (
            <div style={{ background: "#2d1515", border: "1px solid #ef4444", borderRadius: 8, padding: 16, color: "#ef4444", fontSize: 13 }}>
              {error}
            </div>
          )}
            ...
            <div>
              ...
              {activeIdx !== null && activeIdx < items.length - 1 && (
                <div style={{ marginTop: 24, paddingTop: 16, borderTop: "1px solid #21262d" }}>
                  <button
                    onClick={() => handleClick(activeIdx + 1, items[activeIdx + 1])}
                    style={{ padding: "8px 16px", borderRadius: 8, border: "1px solid #30363d", background: "#161b22", color: "#c9d1d9", fontSize: 12, cursor: "pointer" }}
                  >
                    다음 주제: {items[activeIdx + 1]} →
                  </button>
                </div>
              )}
            </div>
